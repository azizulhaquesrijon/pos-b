            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('dokani.users.store') }}" class="form-horizontal">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control only-number" type="text" name="mobile"
                                        value="{{ old('mobile') }}" placeholder="Enter Mobile" autocomplete="off"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="designation"
                                        value="{{ old('designation') }}" placeholder="Type designation" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="password" name="pin" value="{{ old('pin') }}"
                                        placeholder="Type Pin" required autocomplete="nope"/>
                                </div>
                            </div>
