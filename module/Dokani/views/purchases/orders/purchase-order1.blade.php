    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select id="supplier"
                                    ...
                                    data-placeholder="-- Supplier --" required>
                                <option></option>
            ...
            <form action="{{ route('dokani.order-sale') }}" method="POST">
                ...
                <input type="hidden" name="customer_id" class="customer_id" value="{{ $order->supplier_id }}">
                                    ...
                                    <td style="width: 35%; padding: 3px !important; border: 0px !important">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" class="form-control total text-right" name="previous_due"
                                                   id="previous_due" value="{{ round(optional($order->supplier)->balance,2) }}" readonly>
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 35%; padding: 3px !important; border: 0px !important">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" class="form-control total text-right" name="payable_amount"
                                                   id="payable" value="{{ round(optional($order->supplier)->balance + $order->payable_amount,2) }}" readonly>
                                        </div>
                                    </td>
