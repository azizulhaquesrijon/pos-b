    ...
    function products(data) {
        ...
        if (data.length > 0){
            ...
            <a href="javascript:void(0)">
                ...
                <td  width="20%" class="product-unit">${value.unit}</td>
    ...
    function addProduct(id, product_id, title, code, qty, price, vat, table) {
        ...
        if (is_item_added == true) {
            ...
            let tr = `<tr class="mgrid">
                ...
                <td style="width: 15%">
                     <input type="text" name="expire_at[]" placeholder="Expire Date" class="form-control date-picker" autocomplete="off">
                </td>
...
<script>
    function select(el, nodes) {
        ...
        if (elOffset <script scrollTop || (elOffset + elHeight) > viewport)
