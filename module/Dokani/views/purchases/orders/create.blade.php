...
@section('page-header')
    <i class="fa fa-plus"></i> Purchase Order Create
@stop
@push('style')
    <style>
        .list-group>p {
    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h4 class="page-title"><i class="fa fa-list"></i> Purchase Order Create</h4>
                <div class="btn-group">

                </div>
            </div>

            <form action="{{ route('dokani.purchase-orders.store') }}" method="POST">
                @csrf
                                ...
                                <select name="supplier_id" id="supplier"
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <option value="{{ $supplier->id }}"
                                                data-pre_due="{{ $supplier->balance }}" {{ $supplier->dokan_id == null ? 'selected' : '' }}>
                                            {{ $supplier->name }}
                                        </option>
                                    @endforeach
                                </select>
...
@section('js')
    ...
    @include('purchases.orders._inc.order-script')
    <script>
