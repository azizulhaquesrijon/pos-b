...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <form action="{{ route('dokani.create.purchase') }}" method="POST" id="purchase-create">
                @csrf
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    ...
                                    <select name="supplier_id" id="supplier_id" class="form-control chosen-select-100-percent"
