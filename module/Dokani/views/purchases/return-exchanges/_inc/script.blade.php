...
<script>
    ...
    function createReturnList(){
        ...
        $('.product-name').each(function(key, value){
            ...
            let purchasePrice     = _this.find('.product-purchase-price').text();
            let returnQuantity    = _this.find('.return-quantity').val();
            let purchaseDetailId  = _this.find('.purchase-detail-id').val();
            let purchaseDetailLot = _this.find('.purchase-detail-lot').val();

            totalQuantity += Number(returnQuantity);
            totalAmount   += Number(purchasePrice) * Number(returnQuantity);

            if(returnQuantity > 0){
                tr += ` <tr>
                            <input type="hidden" name="return_purchase_detail_id[]" value="${ purchaseDetailId }">
                            <input type="hidden" name="return_product_id[]" value="${ id }">
                            <input type="hidden" name="return_quantity[]" value="${ returnQuantity }">
                            <input type="hidden" name="return_purchase_price[]" value="${ purchasePrice }">
                            <input type="hidden" name="return_subtotal[]" value="${ purchasePrice * returnQuantity }">
                            <input type="hidden" name="return_purchase_detail_lot[]" value="${ purchaseDetailLot }">
        ...
        tr += ` <tr>
                    ...
                    <td>${ totalQuantity }<input type="hidden" name="total_return_quantity" value="${ totalQuantity }"></td>
        ...
        $('#total_return_subtotal').val(totalAmount);
