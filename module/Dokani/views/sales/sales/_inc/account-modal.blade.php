...
{{--                        <div class="table-responsive">--}}
                            <table class="table table-bordered" id="accountTable">
                                ...
                                <tfoot>
                                    <tr class="change_account_tr" style="display: none">
                                        <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <input type="text" id="change_amount" name="change_amount" class="form-control" value="0" readonly>
                                        </td>
                                    ...
                                    <td class="calculation_tr">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                {{-- <input type="hidden" id="change_amount" name="change_amount" value="0"> --}}
                                            </div>
                                        </div>
...
{{--                        </div>--}}
           ...
           <div class="modal-footer">
                <div class="btn-group" style="display: flex">
                    ...
                    <button type="button" class="btn btn-sm btn-primary btn-block save-btn"
