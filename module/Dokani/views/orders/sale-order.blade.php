                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%; padding: 3px !important; border: 0px !important; color: black">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control total text-right" name="all_subtotal"
                                                   id="subtotal" value="{{ round($order->sub_total,2) }}" readonly="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%; padding: 3px !important; border: 0px !important">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" class="form-control text-right discount" name="discount" value="{{ $order->discount }}" id="discount" autocomplete="off" readonly>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 33.33%;padding: 5px">
                                        <div class="col-md-6" style="padding: 0 !important;">
                                            @if (hasPermission('dokani.orders.index', $slugs))
                                                <a href="{{ route('dokani.orders.index') }}" class="btn btn-sm btn-success btn-block" style="width: 100%; border-radius: 0px !important; background-color: #cdffbe !important; border-color: #cdffbe; color: black !important;">
                                        ...
                                        <div class="col-md-6" style="padding: 0 !important;">
                                            <a href="#add-new" role="button" data-toggle="modal"
                                               class="btn btn-sm btn-primary btn-block" style="background-color: #0044ff !important; border-color: #0044ff !important; border-radius: 0px !important;">
                                                <i class="far fa-money"></i> PAY & APPROVE
                                            </a>
                                        </div>
                                    </td>
                                </tr>
