                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between; margin-bottom: 20px">
                        ...
                        <div class="btn-group btn-corner">
                            ...
                            <a class="btn btn-sm btn-black" onclick="labelPrint()">
                                <i class="fa fa-print"></i> Label(W-1.5, H:1 )
                            </a>

                            <a class="btn btn-sm btn-black" onclick="labelPrintCHW()">
                                <i class="fa fa-print"></i> Label(W-1.8, H:1.3)
                            </a>
...
@section('js')
    ...
    <script>
        ...
        function labelPrintCHW() {
            ...
            $('.allPrint').hide();
            // let degrees = 90;
            // $('.labelPrintDiv').css({'transform' : 'rotate('+ degrees +'deg)'});
