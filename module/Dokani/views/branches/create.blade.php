            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('dokani.branches.store') }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="short_name" autocomplete="off"
                                        value="{{ old('short_name') }}" placeholder="Type Short Name"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control only-number" type="text" name="phone_number"
                                        value="{{ old('phone_number') }}" placeholder="Enter Mobile" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="text" name="bin_no" value="{{ old('bin_no') }}" placeholder="Bin No" />
                                </div>
                            </div>
