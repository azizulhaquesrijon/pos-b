            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    ...
                    <span class="widget-toolbar">
                        @if (hasPermission('dokani.stock-adjustments.create', $slugs))
                            <a href="{{ route('dokani.stock-adjustments.index') }}" class="">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form id="stock-transfer-form" class="form-horizontal" action="{{ route('dokani.stock-adjustments.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="input-group mb-1 width-100" style="width: 100%">
                                        <span class="input-group-addon" style="width: 40%; text-align: left">
                                            Branch<span class="label-required"> *</span>
                                        </span>
                                        ...
                                        <table class="table table-bordered fixed-table-header" id="purchaseTable">
                                            <thead>
                                                <tr class="table-header-bg">
                                                    ...
                                                    <th width="8%" class="text-center">Adjustment Type</th>
...
@section('script')
    ...
    @include('branches.stock-adjustment._inc.script')
