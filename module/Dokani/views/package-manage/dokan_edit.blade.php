            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('dokani.shop.update', $user->id) }}" class="form-horizontal">
                        @csrf
                        ...
                        <!-- Name -->
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-sm-3">Pin<sup class="text-danger">*</sup>
                                    :</label>
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="password" name="pin" value="{{ $user->pin }}"
                            ...
                            <!-- MULTIPLE BRANCH -->
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-sm-3">Allow Multi Branch :</label>
                                <div class="col-md-5 col-sm-5">
                                    <label>
                                        <input name="is_multiple_branch" value="1" class="ace ace-switch ace-switch-6" type="checkbox" {{ $user->is_multiple_branch ? 'checked' : '' }}>
                                        <span class="lbl"></span>
                                    </label>
                                </div>
                            </div>
    ...
    padding-left: 17px;"><i class="fa fa-info-circle"></i>&nbsp;<strong>Package</strong></div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-sm-3">Start Date<sup class="text-danger">*</sup>
                                    :</label>
                                <div class="col-md-5 col-sm-5">
                                    <input type="text" name="start_date" value="{{ $package->start_date ?? Carbon\Carbon::now()->format('Y-m-d') }}"
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-sm-3">End Date<sup class="text-danger">*</sup>
                                    :</label>
                                <div class="col-md-5 col-sm-5">
                                    <input type="text" name="end_date" value="{{ $package->end_date ?? '' }}"
                                           class="form-control date-picker" autocomplete="off">
                                </div>
                            </div>
