...
@section('title', 'Productions Issue Details')
            ...
            <div class="widget-box">
                <div class="widget-header no-print">
                    <h4 class="widget-title">
                        <i class="fa fa-plus-circle"></i> Productions Issue Details
                    </h4>
                    ...
                    <span class="widget-toolbar">
                        @if (hasPermission('dokani.production-issues.index', $slugs))
                            <a href="{{ route('dokani.production-issues.index') }}" class="">
                            ...
                            <div id="print_body" class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="invoiceInfo" style="width: 50%; float: left;margin-top: 5px;">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <td> Invoice Id : </td>
                                                    <td>{{ $production_issue->invoice_id }}</td>
                                                </tr>
                                                <tr>
                                                    <td> Date : </td>
                                                    <td>{{ fdate($production_issue->date,'Y-m-d') }}</td>
                                                </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" style="border: none !important">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($production_issue->production_issue_details as $item)
                                                    <tr>
                                ...
                                <div class="print-footer"
                                    ...
                                    <div class="sign" style="width: 100%; overflow: hidden;">
                                        ...
                                        <div class="company_sign" style="width: 33%; float: left;">
                                            <h5 style="width:50%; margin: 0 auto; padding: 10px 0;text-align: center;">
                                                {{ optional($production_issue->user)->name }}
                                                &nbsp;</h5>
                                            <h5
                                                style="width:50%;margin: 0 auto;border-top: 1px solid #000;padding: 10px 0;text-align: center;">
                                                Prepared By</h5>
