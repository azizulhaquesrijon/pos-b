            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('dokani.production-receives.update', $refer->id) }}" class="form-horizontal"
                        ...
                        <!-- Start Price -->
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="number" name="start_price" autocomplete="off"
                                           value="{{ $refer->start_price }}" placeholder="Type Price" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="number" name="end_price"
                                           value="{{ $refer->end_price }}" placeholder="Enter Price" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="number" name="refer_point" value="{{ $refer->refer_point }}"
