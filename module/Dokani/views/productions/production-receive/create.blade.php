...
@section('title', 'Production Receive')

@section('page-header')
    <i class="fa fa-plus"></i> Production Receive
@stop
    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header" style="display: flex; justify-content: space-between;">
                <h4 class="page-title"><i class="fa fa-list"></i> Production - Get Finish Product</h4>
                <div class="btn-group">
                    <a href="{{ route('dokani.production-receives.index') }}" class="btn btn-info btn-sm">
            ...
            <form action="{{ route('dokani.production-receives.store') }}" method="POST">
                @csrf
...
<script src="{{ asset('assets/js/jquery.ba-throttle-debounce.js') }}"></script>
    @include('productions.production-receive._inc.script')
